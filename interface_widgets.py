def construir_interface(janela, repo_var, selecionar_repositorio, acao_atualizar_branch,
                        ...
                        acao_checkout_branch, acao_deletar_branch, acao_criar_pr, editar_config_repositorio,
                        log_output):
    ...
    tk.Button(janela, text="Atualizar Branch Principal", command=acao_atualizar_branch, width=40).pack(pady=5)
    ...
    tk.Button(janela, text="Editar Configuração do PR", command=editar_config_repositorio, width=40).pack(pady=5)
